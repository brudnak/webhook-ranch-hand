...
func TestDashboardKeepsLatestBuildPerStream(t *testing.T) {
	...
	head := reportMeta{
		version: "v2.14.5-4d29026545cefa8ce9d8950d746c4fda80217942-head", line: "v2.14", buildStream: "prime-head",
		rancherDate: time.Date(2026, 8, 19, 14, 0, 0, 0, time.UTC), relPath: "v2.14/head.md",
	}
