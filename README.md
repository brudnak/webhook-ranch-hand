...
| --- | --- | --- | --- | --- | --- | --- |
| v2.16 | `prime-head` | [`v2.16.0-40cc695-head`](reports/v2.16/v2.16.0-40cc695-head.md) | ⚠️ 6 mismatches | `v0.12.1-rc.4` | 2026-09-18 | [open](reports/v2.16/v2.16.0-40cc695-head.md) |
| v2.15 | `prime-head` | [`v2.15.2-d0bc0d0-head`](reports/v2.15/v2.15.2-d0bc0d0-head.md) | ⚠️ 3 mismatches | `v0.11.2-rc.4` | 2026-09-18 | [open](reports/v2.15/v2.15.2-d0bc0d0-head.md) |
...
| v2.14 | `prime-head` | [`v2.14.6-8276843-head`](reports/v2.14/v2.14.6-8276843-head.md) | ⚠️ 1 mismatch | `v0.10.11-rc.4` | 2026-09-18 | [open](reports/v2.14/v2.14.6-8276843-head.md) |
...
| v2.13 | `prime-head` | [`v2.13.10-62590f5-head`](reports/v2.13/v2.13.10-62590f5-head.md) | ⚠️ 5 mismatches | `v0.9.9-rc.2` | 2026-09-18 | [open](reports/v2.13/v2.13.10-62590f5-head.md) |
...
| v2.12 | `prime-head` | [`v2.12.14-1e125b4-head`](reports/v2.12/v2.12.14-1e125b4-head.md) | ⚠️ 1 mismatch | `v0.8.10-rc.4` | 2026-09-18 | [open](reports/v2.12/v2.12.14-1e125b4-head.md) |
...
| v2.11 | `prime-head` | [`v2.11.18-9409959-head`](reports/v2.11/v2.11.18-9409959-head.md) | ⚠️ 1 mismatch | `v0.7.11-rc.4` | 2026-09-18 | [open](reports/v2.11/v2.11.18-9409959-head.md) |
...
- 2026-09-18 · `prime-head` · [`v2.15.2-d0bc0d0-head`](reports/v2.15/v2.15.2-d0bc0d0-head.md) · ⚠️ 3 mismatches
- 2026-09-18 · `prime-head` · [`v2.16.0-40cc695-head`](reports/v2.16/v2.16.0-40cc695-head.md) · ⚠️ 6 mismatches
- 2026-09-18 · `prime-head` · [`v2.12.14-1e125b4-head`](reports/v2.12/v2.12.14-1e125b4-head.md) · ⚠️ 1 mismatch
- 2026-09-18 · `prime-head` · [`v2.11.18-9409959-head`](reports/v2.11/v2.11.18-9409959-head.md) · ⚠️ 1 mismatch
- 2026-09-18 · `prime-head` · [`v2.13.10-62590f5-head`](reports/v2.13/v2.13.10-62590f5-head.md) · ⚠️ 5 mismatches
- 2026-09-18 · `prime-head` · [`v2.14.6-8276843-head`](reports/v2.14/v2.14.6-8276843-head.md) · ⚠️ 1 mismatch
- 2026-09-18 · `prime-head` · [`v2.16.0-ee34c75-head`](reports/v2.16/v2.16.0-ee34c75-head.md) · ⚠️ 6 mismatches
- 2026-09-18 · `prime-head` · [`v2.11.18-67cb6a4-head`](reports/v2.11/v2.11.18-67cb6a4-head.md) · ⚠️ 1 mismatch
- 2026-09-18 · `prime-head` · [`v2.12.14-8a87d14-head`](reports/v2.12/v2.12.14-8a87d14-head.md) · ⚠️ 1 mismatch
- 2026-09-18 · `prime-head` · [`v2.14.6-0f6c130-head`](reports/v2.14/v2.14.6-0f6c130-head.md) · ⚠️ 1 mismatch
