...
| --- | --- | --- | --- | --- | --- | --- |
| v2.16 | `prime-head` | [`v2.16.0-7511952-head`](reports/v2.16/v2.16.0-7511952-head.md) | ⚠️ 6 mismatches | `v0.12.1-rc.4` | 2026-09-11 | [open](reports/v2.16/v2.16.0-7511952-head.md) |
| v2.15 | `prime-head` | [`v2.15.2-f23ada2-head`](reports/v2.15/v2.15.2-f23ada2-head.md) | ⚠️ 6 mismatches | `v0.11.2-rc.1` | 2026-09-11 | [open](reports/v2.15/v2.15.2-f23ada2-head.md) |
...
| v2.14 | `prime-head` | [`v2.14.6-3d0f3c1-head`](reports/v2.14/v2.14.6-3d0f3c1-head.md) | ⚠️ 4 mismatches | `v0.10.11-rc.1` | 2026-09-11 | [open](reports/v2.14/v2.14.6-3d0f3c1-head.md) |
...
| v2.13 | `prime-head` | [`v2.13.10-f6c430b-head`](reports/v2.13/v2.13.10-f6c430b-head.md) | ⚠️ 4 mismatches | `v0.9.8` | 2026-09-11 | [open](reports/v2.13/v2.13.10-f6c430b-head.md) |
...
| v2.12 | `prime-head` | [`v2.12.14-e1edb05-head`](reports/v2.12/v2.12.14-e1edb05-head.md) | ⚠️ 4 mismatches | `v0.8.9` | 2026-09-11 | [open](reports/v2.12/v2.12.14-e1edb05-head.md) |
...
| v2.11 | `prime-head` | [`v2.11.18-4b65cfa-head`](reports/v2.11/v2.11.18-4b65cfa-head.md) | ⚠️ 5 mismatches | `v0.7.10` | 2026-09-11 | [open](reports/v2.11/v2.11.18-4b65cfa-head.md) |
...
- 2026-09-11 · `prime-head` · [`v2.12.14-e1edb05-head`](reports/v2.12/v2.12.14-e1edb05-head.md) · ⚠️ 4 mismatches
- 2026-09-11 · `prime-head` · [`v2.13.10-f6c430b-head`](reports/v2.13/v2.13.10-f6c430b-head.md) · ⚠️ 4 mismatches
- 2026-09-11 · `prime-head` · [`v2.11.18-4b65cfa-head`](reports/v2.11/v2.11.18-4b65cfa-head.md) · ⚠️ 5 mismatches
- 2026-09-11 · `prime-head` · [`v2.14.6-3d0f3c1-head`](reports/v2.14/v2.14.6-3d0f3c1-head.md) · ⚠️ 4 mismatches
- 2026-09-11 · `prime-head` · [`v2.16.0-7511952-head`](reports/v2.16/v2.16.0-7511952-head.md) · ⚠️ 6 mismatches
- 2026-09-11 · `prime-head` · [`v2.15.2-f23ada2-head`](reports/v2.15/v2.15.2-f23ada2-head.md) · ⚠️ 6 mismatches
