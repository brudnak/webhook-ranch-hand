...
| --- | --- | --- | --- | --- | --- | --- |
| v2.16 | `prime-head` | [`v2.16.0-099f261-head`](reports/v2.16/v2.16.0-099f261-head.md) | ⚠️ 6 mismatches | `v0.12.1-rc.4` | 2026-09-16 | [open](reports/v2.16/v2.16.0-099f261-head.md) |
| v2.15 | `prime-head` | [`v2.15.2-ab15f61-head`](reports/v2.15/v2.15.2-ab15f61-head.md) | ⚠️ 2 mismatches | `v0.11.2-rc.2` | 2026-09-16 | [open](reports/v2.15/v2.15.2-ab15f61-head.md) |
...
| v2.14 | `prime-head` | [`v2.14.6-07bb0e4-head`](reports/v2.14/v2.14.6-07bb0e4-head.md) | ✅ Clean | `v0.10.11-rc.2` | 2026-09-16 | [open](reports/v2.14/v2.14.6-07bb0e4-head.md) |
...
| v2.13 | `prime-head` | [`v2.13.10-8452e63-head`](reports/v2.13/v2.13.10-8452e63-head.md) | ✅ Clean | `v0.9.9-rc.1` | 2026-09-16 | [open](reports/v2.13/v2.13.10-8452e63-head.md) |
...
| v2.12 | `prime-head` | [`v2.12.14-89e61f6-head`](reports/v2.12/v2.12.14-89e61f6-head.md) | ✅ Clean | `v0.8.10-rc.1` | 2026-09-16 | [open](reports/v2.12/v2.12.14-89e61f6-head.md) |
...
| v2.11 | `prime-head` | [`v2.11.18-5cf8e8b-head`](reports/v2.11/v2.11.18-5cf8e8b-head.md) | ✅ Clean | `v0.7.11-rc.1` | 2026-09-16 | [open](reports/v2.11/v2.11.18-5cf8e8b-head.md) |
...
- 2026-09-15 · `prime-head` · [`v2.14.6-07bb0e4-head`](reports/v2.14/v2.14.6-07bb0e4-head.md) · ✅ Clean
- 2026-09-15 · `prime-head` · [`v2.16.0-099f261-head`](reports/v2.16/v2.16.0-099f261-head.md) · ⚠️ 6 mismatches
- 2026-09-15 · `prime-head` · [`v2.11.18-5cf8e8b-head`](reports/v2.11/v2.11.18-5cf8e8b-head.md) · ✅ Clean
- 2026-09-15 · `prime-head` · [`v2.15.2-ab15f61-head`](reports/v2.15/v2.15.2-ab15f61-head.md) · ⚠️ 2 mismatches
- 2026-09-15 · `prime-head` · [`v2.13.10-8452e63-head`](reports/v2.13/v2.13.10-8452e63-head.md) · ✅ Clean
- 2026-09-15 · `prime-head` · [`v2.12.14-89e61f6-head`](reports/v2.12/v2.12.14-89e61f6-head.md) · ✅ Clean
- 2026-09-15 · `prime-head` · [`v2.11.18-32a43e5-head`](reports/v2.11/v2.11.18-32a43e5-head.md) · ✅ Clean
- 2026-09-15 · `prime-head` · [`v2.16.0-85d7896-head`](reports/v2.16/v2.16.0-85d7896-head.md) · ⚠️ 6 mismatches
- 2026-09-15 · `prime-head` · [`v2.12.14-4d1cb7b-head`](reports/v2.12/v2.12.14-4d1cb7b-head.md) · ✅ Clean
- 2026-09-15 · `prime-head` · [`v2.13.10-2a3f4a4-head`](reports/v2.13/v2.13.10-2a3f4a4-head.md) · ✅ Clean
