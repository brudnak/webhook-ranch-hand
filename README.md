...
| v2.15 | `prime-head` | [`v2.15.1-c033d66-head`](reports/v2.15/v2.15.1-c033d66-head.md) | ⚠️ 2 mismatches | `v0.11.1` | 2026-08-26 | [open](reports/v2.15/v2.15.1-c033d66-head.md) |
...
| v2.14 | `prime-head` | [`v2.14.5-052ba56-head`](reports/v2.14/v2.14.5-052ba56-head.md) | ✅ Clean | `v0.10.10` | 2026-08-26 | [open](reports/v2.14/v2.14.5-052ba56-head.md) |
