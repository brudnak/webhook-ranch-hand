...
| --- | --- | --- | --- | --- | --- | --- |
| v2.16 | `prime-head` | [`v2.16.0-de47bc4-head`](reports/v2.16/v2.16.0-de47bc4-head.md) | ⚠️ 3 mismatches | `v0.12.1-rc.3` | 2026-08-24 | [open](reports/v2.16/v2.16.0-de47bc4-head.md) |
| v2.15 | `prime-head` | [`v2.15.1-c1e7f21-head`](reports/v2.15/v2.15.1-c1e7f21-head.md) | ⚠️ 2 mismatches | `v0.11.1` | 2026-08-25 | [open](reports/v2.15/v2.15.1-c1e7f21-head.md) |
...
| v2.14 | `prime-head` | [`v2.14.5-402f065-head`](reports/v2.14/v2.14.5-402f065-head.md) | ✅ Clean | `v0.10.10-rc.4` | 2026-08-25 | [open](reports/v2.14/v2.14.5-402f065-head.md) |
...
| v2.13 | `prime-head` | [`v2.13.9-fea08d3-head`](reports/v2.13/v2.13.9-fea08d3-head.md) | ✅ Clean | `v0.9.8-rc.4` | 2026-08-25 | [open](reports/v2.13/v2.13.9-fea08d3-head.md) |
...
| v2.12 | `prime-head` | [`v2.12.13-f003ed5-head`](reports/v2.12/v2.12.13-f003ed5-head.md) | ⚠️ 4 mismatches | `v0.8.9` | 2026-08-25 | [open](reports/v2.12/v2.12.13-f003ed5-head.md) |
...
| v2.11 | `prime-head` | [`v2.11.17-681a53c-head`](reports/v2.11/v2.11.17-681a53c-head.md) | ⚠️ 5 mismatches | `v0.7.10` | 2026-08-25 | [open](reports/v2.11/v2.11.17-681a53c-head.md) |
...
- 2026-08-25 · `prime-head` · [`v2.15.1-c1e7f21-head`](reports/v2.15/v2.15.1-c1e7f21-head.md) · ⚠️ 2 mismatches
- 2026-08-25 · `prime-head` · [`v2.13.9-fea08d3-head`](reports/v2.13/v2.13.9-fea08d3-head.md) · ✅ Clean
- 2026-08-25 · `prime-head` · [`v2.12.13-f003ed5-head`](reports/v2.12/v2.12.13-f003ed5-head.md) · ⚠️ 4 mismatches
- 2026-08-25 · `prime-head` · [`v2.14.5-402f065-head`](reports/v2.14/v2.14.5-402f065-head.md) · ✅ Clean
- 2026-08-25 · `prime-head` · [`v2.11.17-681a53c-head`](reports/v2.11/v2.11.17-681a53c-head.md) · ⚠️ 5 mismatches
- 2026-08-24 · `prime-head` · [`v2.15.1-29c07aa-head`](reports/v2.15/v2.15.1-29c07aa-head.md) · ⚠️ 2 mismatches
- 2026-08-24 · `prime-head` · [`v2.11.17-7f1c0c5-head`](reports/v2.11/v2.11.17-7f1c0c5-head.md) · ⚠️ 5 mismatches
- 2026-08-24 · `prime-head` · [`v2.14.5-02a743e-head`](reports/v2.14/v2.14.5-02a743e-head.md) · ✅ Clean
- 2026-08-24 · `prime-head` · [`v2.13.9-9a613b1-head`](reports/v2.13/v2.13.9-9a613b1-head.md) · ✅ Clean
- 2026-08-24 · `prime-head` · [`v2.16.0-de47bc4-head`](reports/v2.16/v2.16.0-de47bc4-head.md) · ⚠️ 3 mismatches
