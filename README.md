...
| --- | --- | --- | --- | --- | --- | --- |
| v2.16 | `prime-head` | [`v2.16.0-f548dfa-head`](reports/v2.16/v2.16.0-f548dfa-head.md) | ⚠️ 6 mismatches | `v0.12.1-rc.4` | 2026-09-22 | [open](reports/v2.16/v2.16.0-f548dfa-head.md) |
| v2.15 | `prime-head` | [`v2.15.2-18faa2f-head`](reports/v2.15/v2.15.2-18faa2f-head.md) | ⚠️ 3 mismatches | `v0.11.2-rc.4` | 2026-09-22 | [open](reports/v2.15/v2.15.2-18faa2f-head.md) |
...
| v2.14 | `prime-head` | [`v2.14.6-4780fbe-head`](reports/v2.14/v2.14.6-4780fbe-head.md) | ⚠️ 1 mismatch | `v0.10.12` | 2026-09-22 | [open](reports/v2.14/v2.14.6-4780fbe-head.md) |
...
| v2.13 | `prime-head` | [`v2.13.10-4e0c2dd-head`](reports/v2.13/v2.13.10-4e0c2dd-head.md) | ⚠️ 1 mismatch | `v0.9.10` | 2026-09-22 | [open](reports/v2.13/v2.13.10-4e0c2dd-head.md) |
...
| v2.12 | `prime-head` | [`v2.12.14-ef353a6-head`](reports/v2.12/v2.12.14-ef353a6-head.md) | ⚠️ 1 mismatch | `v0.8.11` | 2026-09-22 | [open](reports/v2.12/v2.12.14-ef353a6-head.md) |
...
| v2.11 | `prime-head` | [`v2.11.18-9e89b70-head`](reports/v2.11/v2.11.18-9e89b70-head.md) | ⚠️ 1 mismatch | `v0.7.12` | 2026-09-22 | [open](reports/v2.11/v2.11.18-9e89b70-head.md) |
...
- 2026-09-22 · `prime-head` · [`v2.15.2-18faa2f-head`](reports/v2.15/v2.15.2-18faa2f-head.md) · ⚠️ 3 mismatches
- 2026-09-22 · `prime-head` · [`v2.11.18-9e89b70-head`](reports/v2.11/v2.11.18-9e89b70-head.md) · ⚠️ 1 mismatch
- 2026-09-22 · `prime-head` · [`v2.16.0-f548dfa-head`](reports/v2.16/v2.16.0-f548dfa-head.md) · ⚠️ 6 mismatches
- 2026-09-22 · `prime-head` · [`v2.13.10-4e0c2dd-head`](reports/v2.13/v2.13.10-4e0c2dd-head.md) · ⚠️ 1 mismatch
- 2026-09-22 · `prime-head` · [`v2.12.14-ef353a6-head`](reports/v2.12/v2.12.14-ef353a6-head.md) · ⚠️ 1 mismatch
- 2026-09-22 · `prime-head` · [`v2.14.6-4780fbe-head`](reports/v2.14/v2.14.6-4780fbe-head.md) · ⚠️ 1 mismatch
